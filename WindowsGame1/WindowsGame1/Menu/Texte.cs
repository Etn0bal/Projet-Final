...
namespace AtelierXNA
{
    ...
    public class Texte : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        RessourcesManager<SpriteFont> GestionnaireDePoliceDeCaractËre { get; set; }

        public Texte(Microsoft.Xna.Framework.Game jeu, string texte¿Afficher, string nomFont, Rectangle zoneAffichage,Vector2 positionAffichage,
        ...
        protected override void LoadContent()
        {
            ...
            GestionnaireDePoliceDeCaractËre = Game.Services.GetService(typeof(RessourcesManager<SpriteFont>)) as RessourcesManager<SpriteFont>;
            PoliceDeCaractËres = GestionnaireDePoliceDeCaractËre.Find(NomFont);
