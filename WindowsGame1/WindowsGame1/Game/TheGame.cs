    ...
    public class TheGame : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Initialize()
        {
            ...
            if (NumClient == 0)
            {
                ...
                Joueur = new EntitéJoueur(Game, "robot2", ÉCHELLE_OBJET_JOUEUR, rotationObjetInitialeHost, positionInitialeHost, INTERVALLE_MAJ, 1, 1, 1, 1, 1, new Vector3(1, 0, 0));
                Game.Components.Add(Joueur);
                JoueurEnnemie = new EntitéEnnemie(Game, "robot2", ÉCHELLE_OBJET_JOUEUR, rotationObjetInitialeInvite, positionInitialeInvite, INTERVALLE_MAJ, 1, 1, 1, 1, 1,new Vector3(-1, 0, 0));
                Game.Components.Add(JoueurEnnemie);
                //Péons :
                PéonA1 = new EntitéPéonAlliée(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeHost, positionInitialeHost - new Vector3(0, 0, 5), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(1, 0, 0),1);
                Game.Components.Add(PéonA1);
                PéonA2 = new EntitéPéonAlliée(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeHost, positionInitialeHost + new Vector3(5, 0, 0), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(1, 0, 0),2);
                Game.Components.Add(PéonA2);
                PéonA3 = new EntitéPéonAlliée(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeHost, positionInitialeHost + new Vector3(0, 0, 5), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(1, 0, 0),3);
                Game.Components.Add(PéonA3);

                //Péons :
                PéonE1 = new EntitéPéonEnnemie(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeInvite, positionInitialeInvite - new Vector3(0, 0, 5), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(-1, 0, 0),1);
                Game.Components.Add(PéonE1);
                PéonE2 = new EntitéPéonEnnemie(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeInvite, positionInitialeInvite - new Vector3(5, 0, 0), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(-1, 0, 0),2);
                Game.Components.Add(PéonE2);
                PéonE3 = new EntitéPéonEnnemie(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeInvite, positionInitialeInvite + new Vector3(0, 0, 5), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(-1, 0, 0),3);
            ...
            if (NumClient == 1)
            {
                ...
                //Joueurs :
                Joueur = new EntitéJoueur(Game, "robot2", ÉCHELLE_OBJET_JOUEUR, rotationObjetInitialeInvite, positionInitialeInvite, INTERVALLE_MAJ, 1, 1, 1, 1, 1, new Vector3(-1, 0, 0));
                Game.Components.Add(Joueur);
                JoueurEnnemie = new EntitéEnnemie(Game, "robot2", ÉCHELLE_OBJET_JOUEUR, rotationObjetInitialeHost, positionInitialeHost, INTERVALLE_MAJ, 1, 1, 1, 1, 1, new Vector3(1, 0, 0));
                Game.Components.Add(JoueurEnnemie);
                //Péons :
                PéonA1 = new EntitéPéonAlliée(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeInvite, positionInitialeInvite - new Vector3(0, 0, 5), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(-1, 0, 0),1);
                Game.Components.Add(PéonA1);
                PéonA2 = new EntitéPéonAlliée(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeInvite, positionInitialeInvite - new Vector3(5, 0, 0), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(-1, 0, 0),2);
                Game.Components.Add(PéonA2);
                PéonA3 = new EntitéPéonAlliée(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeInvite, positionInitialeInvite + new Vector3(0, 0, 5), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(-1, 0, 0),3);
                Game.Components.Add(PéonA3);

                //Péons :
                PéonE1 = new EntitéPéonEnnemie(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeHost, positionInitialeHost - new Vector3(0, 0, 5), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(1, 0, 0),1);
                Game.Components.Add(PéonE1);
                PéonE2 = new EntitéPéonEnnemie(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeHost, positionInitialeHost - new Vector3(5, 0, 0), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(1, 0, 0),2);
                Game.Components.Add(PéonE2);
                PéonE3 = new EntitéPéonEnnemie(Game, "robot2", ÉCHELLE_OBJET_PÉON, rotationObjetInitialeHost, positionInitialeHost + new Vector3(0, 0, 5), INTERVALLE_MAJ, 1, 3, 1, 1, 1, new Vector3(1, 0, 0),3);
                Game.Components.Add(PéonE3);
            }
